...
| `missing-breach-log-001` | Section 12B, Amendment Act 2024 | The amendment source confirms the 2024 amendment; verify commencement and the exact application of Section 12B for the deployment context before relying on this mapping. |
